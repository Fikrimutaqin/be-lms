...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get course enrollment and score statistics' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Return course statistics.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Return a course.', type: course_entity_1.Course }),
