...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get unread notifications for a specific user' }),
    (0, swagger_1.ApiResponse)({ status: 200, type: [notification_entity_1.Notification] }),
    __param(0, (0, common_1.Param)('userId', common_1.ParseUUIDPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Mark all notifications as read for a specific user' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 204, description: 'Notification successfully deleted.' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
